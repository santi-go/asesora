<template>
  <div>
    ...
    <asesora-company :values="values" :labels="labels" :cnaecatalog="cnaecatalog" :validatedcif="validatedcif"></asesora-company>
...
export default {
  ...
  props: ['labels', 'values', 'fullfilled', 'errors', 'editionmode', 'cnaecatalog', 'validatedcif'],
